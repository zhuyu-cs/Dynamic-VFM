...
from neuralpredictors.data.utils import zip_dir, recursively_load_dict_contents_from_group
...
default_image_datapoint = namedtuple("DefaultDataPoint", ["images"])
